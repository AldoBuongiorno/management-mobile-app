      ...
      child: Container(
        margin: EdgeInsets.symmetric(
          ...
          child: Column(
            ...
            children: [
              CustomHeadingTitle(titleText: 'Impostazioni'),
                    ...
                    return Column(
                      children: [
                        Row(
                          ...
                          children: [
                            const Expanded(
                              child: Text("Numero di progetti visualizzati in homepage:")
                            ),
                            InputQty.int(
                              ...
                              minVal: 1,
                              maxVal: 15,
                              onQtyChanged: (value) => DatabaseHelper.instance.updateSetting(
                        ...
                        Row(
                          ...
                          children: [
                            const Expanded(
                              child: Text("Numero di team visualizzati in homepage:")
                            ),
                            InputQty.int(
                              decoration: QtyDecorationProps(
                                border: OutlineInputBorder(
                  ...
                  Expanded(
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        ...
                        minimumSize: const Size.fromHeight(80),
                        padding: const EdgeInsets.symmetric(horizontal: 10),
                        foregroundColor: const Color.fromARGB(255, 245, 220, 0),
                        backgroundColor: Colors.white,
                      ),
                      onPressed: () {
                        Navigator.push(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  const Expanded(child: Text("Elimina tutti i dati presenti:")),
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      padding: const EdgeInsets.symmetric(horizontal: 10),
                    ...
                    onPressed: () {
                      showDialog<String>(
                        ...
                        builder: (BuildContext context) => AlertDialog(
                          ...
                          content: const Text("Una volta che i dati sono stati eliminati,non sarà più possibile recuperarli.\nSei sicuro di voler procedere?"),
                          actions: <Widget>[
                            TextButton(
                              onPressed: () => Navigator.pop(context, 'Annulla'),
                              child: const Text('Annulla', style: TextStyle(color: Colors.lightBlue)),
                            ),
                            TextButton(
                              onPressed: () async {
                                    ...
                                    content: Container(
                                      ...
                                      child: BlurredBox(
                                        ...
                                        child: const Column(
                                          children: [
                                            SizedBox(height: 10),
                                            Text('Tutti i dati sono stati eliminati'),
                                            SizedBox(height: 10)
                                          ]
                                        )
                                      )
                              ...
                              child: const Text('Conferma', style: TextStyle(color: Colors.pink)),
                            ),
                          ],
                        ),
                      );
