            ...
            child: BlurredBox(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  suffixIcon: IconButton(
                    onPressed: () async {
                      if (taskInputController.text.isNotEmpty) {
                        if (!cTasks.any((task) => task.name == taskInputController.text)) {
                          cTasks.add(Task(name: taskInputController.text));
                        }
                      }
                  ...
                  hintStyle: const TextStyle(color: Color.fromARGB(255, 214, 214, 214))
                ),
              )
            ),
          ),
            ...
            onPressed: () async {
              ...
              teamsList.isEmpty ? showDialog<String>(
                ...
                builder: (BuildContext context) => AlertDialog(
                  ...
                  content: const Text("Il progetto non può avere nome o descrizione vuoto.\nInoltre devono essere possibile assegnare un team al progetto."),
                  actions: <Widget>[
                    TextButton(
