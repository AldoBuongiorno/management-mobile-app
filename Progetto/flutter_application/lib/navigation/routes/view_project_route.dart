          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                  ...
                  text: TextSpan(
                    children: [
                      const TextSpan(
                        ...
                        text: 'Attualmente al progetto sta lavorando il team '
                      ),
                      TextSpan(
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return DatePickerDialog(
                              currentDate: widget.project.expirationDate,
                              cancelText: 'Annulla',
                          ...
                          selectedDate != null ? 
                          {
                            DatabaseHelper.instance.updateExpirationDate(
                              widget.project.name,
                              selectedDate
                            ),
                            setState(() {
                    ...
                    child: Row(
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: widget.project.status == 'Attivo' ? null : () async {
                        ...
                        ElevatedButton(
                          ...
                          onPressed: widget.project.status == 'Fallito' ? null : () async {
                            showDialog(
                              context: context,
                              builder: ((context) {
                                return AlertDialog(
                                  ...
                                  content: BlurredBox(
                                    ...
                                    child: TextField(
                                      ...
                                      decoration: const InputDecoration(
                                        ...
                                        hintText: 'Inserisci la motivazione del fallimento',
                                  ...
                                  actions: [
                                    TextButton(
                                      onPressed: () {
                                        ...
                                        DatabaseHelper.instance.updateFailureReason(
                                          widget.project.name,
                                          failureReasonController.text
                                        );
                                        DatabaseHelper.instance.updateStatus(
                                          widget.project.name,
                                          'Fallito'
                                        );
                                        widget.project.projectFailureReason = failureReasonController.text;
                                        setState(() {});
                        ...
                        ElevatedButton(
                          ...
                          onPressed: widget.project.status == 'Completato' ? null : () async {
                            DatabaseHelper.instance.updateStatus(
                              widget.project.name,
                              "Completato"
                            );
                            widget.project.status = 'Completato';
                            DatabaseHelper.instance.updateTaskAsCompletedByProjectName(
                              widget.project.name
                            );
                            setState(() {});
                          },
                        ...
                        ElevatedButton(
                          ...
                          onPressed: widget.project.status == 'Sospeso' ? null : () async {
                            DatabaseHelper.instance.updateStatus(
                              widget.project.name,
                              "Sospeso"
                            );
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            DatabaseHelper.instance.deleteProject(widget.project.name);
                            Navigator.of(context).pop();
                          },
                          child: const Row(
                            children: [
                ...
                const Text('Per aggiungere task modifica il progetto cliccando in alto a destra.')
              ],
            ),
          ),
        )
