  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Row(children: [CustomHeadingTitle(titleText: "Nome membro")]),
          ...
          const SizedBox(height: 10),
          const Row(
              children: [CustomHeadingTitle(titleText: "Cognome membro")]),
          const SizedBox(height: 10),
          BlurredBox(
              borderRadius: BorderRadius.circular(30),
              sigma: 15,
          ...
          const SizedBox(height: 10),
          const Row(children: [CustomHeadingTitle(titleText: "Ruolo membro")]),
          const SizedBox(height: 10),
          BlurredBox(
              borderRadius: BorderRadius.circular(30),
              sigma: 15,
                ...
                if (memberNameController.text.isEmpty ||
                  ...
                  showDialog<String>(
                    ...
                    builder: (BuildContext context) => AlertDialog(
                      ...
                      content:
                          const Text("Tutti i campi devono essere non vuoti."),
                      actions: <Widget>[
                        TextButton(
