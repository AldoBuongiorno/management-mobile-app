...
class TasksCheckboxViewForHomepage extends StatefulWidget {
  ...
  @override
  State<TasksCheckboxViewForHomepage> createState() => _TasksCheckboxViewForHomepageState();
}

class _TasksCheckboxViewForHomepageState extends State<TasksCheckboxViewForHomepage> {
  @override
  Widget build(BuildContext context) {
    return widget.tasks.isEmpty ? const Text('Non sono presenti task.') : ListView.builder(
      shrinkWrap: true,
      ...
      itemBuilder: (context, index) {
        return CheckboxListTile(
          ...
          onChanged: (bool? value) {
            setState(() {
              widget.tasks[index].completed = value ?? false; // Imposta completed a value se value non è nullo, altrimenti a false.
...
class TasksCheckboxView extends StatefulWidget {
  ...
  @override
  State<TasksCheckboxView> createState() => _TasksCheckboxViewState();
}
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return CheckboxListTile(
          ...
          onChanged: (bool? value) {
            setState(() {
              widget.tasks[index].completed = value! ?  true : false;
