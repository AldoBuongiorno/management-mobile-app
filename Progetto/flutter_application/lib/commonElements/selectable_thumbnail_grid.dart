...
class SelectableThumbnailGrid extends StatefulWidget {
  SelectableThumbnailGrid({super.key, this.selectedThumbnail = 0, required this.list });
  ...
  @override
  State<SelectableThumbnailGrid> createState() => _SelectableThumbnailGridState();
}
          ...
          return GestureDetector(
            ...
            child: Card(
              child: Container(
                ...
                height: 200,
                width: 200,
                child: widget.selectedThumbnail == index ? BlurredBox(
                  borderRadius: BorderRadius.circular(10),
                  sigma: 2,
                  child: Container(
                    ...
                    child: Center(
                      child: ShaderMask(
                        ...
                        child: Icon(
                          ...
                          size: MediaQuery.of(context).orientation == Orientation.portrait ? 35 : 45,
                        ),
                      ),
                    ),
                  ),
